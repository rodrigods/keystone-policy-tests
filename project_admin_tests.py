...
class ProjectAdminTests(keystonetests.KeystonePolicyTests):
...
class ProjectsTests(ProjectAdminTests):
    ...
    def test_update_project(self):
        ...
        # NOT AUTHORIZED
        description = 'new description p2'
        with self.assertRaises(Exception):
            self.client.projects.update(self.p2, description=description)
    ...
    def test_list_project_users(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.users.list(default_project=self.p2)
    ...
    def test_list_project_user_roles(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.roles.list(user=self.p2member,
                                   project=self.p2)
    ...
    def test_check_user_role_in_project(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.roles.check(self.member_role, user=self.p2member,
                                    project=self.p2)
    ...
    def test_revoke_user_role_in_project(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.roles.revoke(self.member_role, user=self.p2member,
                                     project=self.p2)
...
class UsersTests(ProjectAdminTests):
    ...
    def test_get_user(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.users.get(self.p2member)
    ...
    def test_update_user_password(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.users.update(self.p2member, password='p2member')
...
class CredentialsTests(ProjectAdminTests):
    ...
    def test_add_credential(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.credentials.create(self.p2member, 'ec2',
                                           blob=blob,
                                           project=self.p2)
    ...
    def test_list_credentials(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.credentials.list(project=self.p2)
    ...
    def test_get_credential(self):
        ...
        test1 = self._create_test_credential(self.p1member, 'ec2',
                                             blob, self.p1)
        test2 = self._create_test_credential(self.p2member, 'ec2',
                                             blob, self.p2)
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.credentials.get(test2)
    ...
    def test_update_credential(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.credentials.update(test2, blob=blob)
    ...
    def test_delete_credential(self):
        ...
        # NOT AUTHORIZED
        with self.assertRaises(Exception):
            self.client.credentials.delete(test2)
